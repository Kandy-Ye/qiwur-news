...
class UsersController extends AppController {
	...
	public function admin_performance($id = null, $start = null, $end = null) {
		if (!$id) {
    ...
    $performance = array();
    $performance['Performance']['order_created'] = $this->Operation->find('count', 
    	array('conditions' => array(
    		'Operation.action' => 'Created',
    		'Operation.last_status' => 'Created',
    		'Operation.created BETWEEN ? AND ?' => array($start, $end),
    		'Operation.user_id' => $id
    )));

    $performance['Performance']['order_confirmed'] = $this->Operation->find('count', 
    	array('conditions' => array(
    ...
    $performance['Performance']['order_dispatched'] = $this->Operation->find('count', 
    	array('conditions' => array(
    		'Operation.action' => 'Dispatch',
    		'Operation.last_status' => array('Confirm', 'Dispatched'), // because there is a bug in release_v2_1
    		'Operation.created BETWEEN ? AND ?' => array($start, $end),
    		'Operation.user_id' => $id
    )));

    $performance['Performance']['order_aborted_at_created'] = $this->Operation->find('count', 
    	array('conditions' => array(
    		'Operation.action' => 'Abort',
    		'Operation.last_status' => 'Created',
    		'Operation.created BETWEEN ? AND ?' => array($start, $end),
    		'Operation.user_id' => $id
    )));

    $performance['Performance']['order_aborted_at_dispatched'] = $this->Operation->find('count', 
    	array('conditions' => array(
    		'Operation.action' => 'Abort',
    		'Operation.last_status' => 'Dispatched',
    		'Operation.created BETWEEN ? AND ?' => array($start, $end),
    		'Operation.user_id' => $id
    )));

    $performance['Performance']['order_inquiried'] = $this->Operation->find('count', 
    	array('conditions' => array(
    		'Operation.action' => 'Created',
    		'Operation.last_status' => 'Created',
    		'Operation.created BETWEEN ? AND ?' => array($start, $end),
    ...
    $performance['Performance']['order_twice_inquiried'] = $this->Operation->find('count', 
    	array('conditions' => array(
    		'Operation.action' => 'Created',
    		'Operation.last_status' => 'Created',
    		'Operation.created BETWEEN ? AND ?' => array($start, $end),
    ...
    $performance['Performance']['order_tags'] = $this->Operation->find('count', 
    	array('conditions' => array(
    		'Operation.action' => 'Created',
    		'Operation.last_status' => 'Created',
    		'Operation.created BETWEEN ? AND ?' => array($start, $end),
    ...
    $performance['Performance']['order_comments'] = $this->Operation->find('count', 
    	array('conditions' => array(
    		'Operation.action' => 'Created',
    		'Operation.last_status' => 'Created',
    		'Operation.created BETWEEN ? AND ?' => array($start, $end),
